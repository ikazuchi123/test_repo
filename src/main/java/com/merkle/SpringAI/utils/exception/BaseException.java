...
public class BaseException extends RuntimeException {
    ...
    private static final long serialVersionUID = -7004661287987173109L;
    ...
    public BaseException(String message, Throwable cause, Collection<?> details) {
        super(message, cause);
        setDetails(details);
    }
    ...
    public void setDetails(Collection<?> details) {
        // cast AbstractList (from Arrays.asList) to ArrayList, so that the list
        // can add items;
